...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-header" style="background-color: #1976D2;">
        <h4 class="modal-title text-white">Javerim App</h4>
        <img src="../img/javerim_inicio.png" alt="logo" height="64p">
    </div>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-block btn-success" data-dismiss="modal">Aceptar</button>
    </div>
</div>